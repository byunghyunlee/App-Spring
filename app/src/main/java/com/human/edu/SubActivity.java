...
public class SubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerAdapter.setOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                ...
                //Toast.makeText(getApplicationContext(),"현재선택한 회원ID는 "+currentCursorId, Toast.LENGTH_SHORT).show();
    ...
    //RestAPI 서버로 UserId를 전송해서 스피링앱의 사용자를 삭제하는 메서드
    private void deleteUserData(int position, String currentCursorId) {
        ...
        DialogInterface.OnClickListener deleteListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String requestUrl = "http://192.168.219.109:8080/android/delete/" + currentCursorId;
                PostResponseAsyncTask deleteTask = new PostResponseAsyncTask(SubActivity.this, new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        if (output.equals("success")) {
                            Toast.makeText(SubActivity.this, "삭제성공", Toast.LENGTH_LONG).show();
                            getAllData();
                        } else {
                            Toast.makeText(SubActivity.this, "삭제 실패", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void getAllData() {
        ...
        String requestUrl = "http://192.168.219.109:8080/android/list";
